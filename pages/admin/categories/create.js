...
function CreateCategory() {
  ...
  const thumbs = files.map((file) => (
    <div className="inline-flex rounded p-1 border box-border h-24 w-24 mr-1 mb-1" key={file.name}>
      ...
      <section className="text-gray-600 body-font relative">
        <div className="flex flex-wrap -m-2">
          ...
          <section className="p-2 w-full">
            <div {...getRootProps({ className: "border border-dashed border-gray-300 rounded h-24 w-full flex justify-center items-center bg-gray-50" })}>
              <input {...getInputProps()} />
